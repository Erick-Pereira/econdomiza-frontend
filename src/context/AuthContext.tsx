...
import { clearAllClientSession, forceLoginRedirect, SESSION_STORAGE_KEYS } from '../lib/browser-session';
...
export const AuthContext = createContext<(AuthSessionValue & { actions: AuthSessionActions }) | null>(null);

export const AuthProvider: React.FC<AuthSessionProviderProps> = ({
  children,
  initialProfile,
